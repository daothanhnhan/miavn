...
class action_cart extends library{
  ...
  /*-------------------------------------------------*/
  public function addCart($total_price, $session_id, $name_buyer, $email_buyer, $phone_buyer, $address_buyer, $note_buyer, $region, $subregion){

    global $conn_vn;
    $date_cart = $this->sw_get_current_weekday();
    $sql = "INSERT into cart (session_id, total_price, date_cart, name_buyer, mail_buyer, phone_buyer, address_buyer, note_buyer, region, subregion) values ('".$session_id."',"."'".$total_price."',"."'".$date_cart."',"."'".$name_buyer."',"."'".$email_buyer."',"."'".$phone_buyer."',"."'".$address_buyer."',"."'".$note_buyer."',"."'".$region."',"."'".$subregion."')";
    $result = mysqli_query($conn_vn,$sql);  
  ...
  public function payment1 () {
      ...
      if(isset($_POST['txtAddress'])) $address_buyer = $_POST['txtAddress'];
      if(isset($_POST['txtNote'])) $note_buyer = $_POST['txtNote'];
      $name_buyer = $_POST['name'];
      $phone_buyer = $_POST['phone'];
      ...
      $session_id = session_id();    
      $id_cart = $this->addCart(0, $session_id, $name_buyer, $email_buyer, $phone_buyer, $address_buyer, $note_buyer, $region, $subregion);
      foreach ($rows as $row) {
          $this->addItemCart($row->id_product, $row->count, $row->price, $session_id, $row->color, $row->size, $row->id_color, $row->id_size, $id_cart);
          $totalPrice += $row->total;              
      }
