            ...
            <div class="row">
                <div class="contentPage">
                    ...
                    <div class="box2">
                        ...
                        <label for="note_buyer">Tỉnh: </label>
                        <input type="text" class="form-control" name="note_buyer" value="<?= $rowOrder['region']; ?>">

                        <label for="note_buyer">Huyện: </label>
                        <input type="text" class="form-control" name="note_buyer" value="<?= $rowOrder['subregion']; ?>">
