<?php 
	...
	function brand () {
		...
		if (isset($_POST['add_brand'])) {
			...
			$sql = "INSERT INTO brand (name, category) VALUES ('$name', $category)";//echo $sql;
			$result = mysqli_query($conn_vn, $sql) or die('loi:');
			echo '<script type="text/javascript">alert(\'Bạn đã thêm Thương hiệu thước thành công.\');window.location.href="index.php?page=brand"</script>';
		}
	}
