        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ////////////// kich thuoc ////////////
                    case "size":
                        include_once("template/size/size.php");
                        break;
                    case "them-size":
                        include_once("template/size/them-size.php");
                        break;
                    case "sua-size":
                        include_once("template/size/sua-size.php");
                        break;
                    case "xoa-size":
                        include_once("template/size/xoa-size.php");
                        break;
                    ///////////// thương hiệu ////////////
                    case "brand":
                        include_once("template/brand/brand.php");
                        break;
                    case "them-brand":
                        include_once("template/brand/them-brand.php");
                        break;
                    case "sua-brand":
                        include_once("template/brand/sua-brand.php");
                        break;
                    case "xoa-brand":
                        include_once("template/brand/xoa-brand.php");
                        break;
                    ////////////// chat lieu //////////////
                    case "material":
                        include_once("template/material/material.php");
                        break;
                    case "them-material":
                        include_once("template/material/them-material.php");
                        break;
                    case "sua-material":
                        include_once("template/material/sua-material.php");
                        break;
                    case "xoa-material":
                        include_once("template/material/xoa-material.php");
                        break;
                    /////////// ngan chưa lap top /////////
                    case "laptop":
                        include_once("template/laptop/laptop.php");
                        break;
                    case "them-laptop":
                        include_once("template/laptop/them-laptop.php");
                        break;
                    case "sua-laptop":
                        include_once("template/laptop/sua-laptop.php");
                        break;
                    case "xoa-laptop":
                        include_once("template/laptop/xoa-laptop.php");
                        break;
                    ////////////// nhom san pham /////////
                    case "nhom-san-pham":
                    ...
                    ///////////////// news slide //////////////
                    case "news-slide":
                        include_once("template/news-slide/news-slide.php");
                        break;
                    case "them-news-slide":
                        include_once("template/news-slide/them-news-slide.php");
                        break;
                    case "sua-news-slide":
                        include_once("template/news-slide/sua-news-slide.php");
                        break;
                    case "xoa-news-slide":
                        include_once("template/news-slide/xoa-news-slide.php");
                        break;
                    ///////////////// news banner //////////////
                    case "news-banner":
                        include_once("template/news-banner/news-banner.php");
                        break;
                    case "them-news-banner":
                        include_once("template/news-banner/them-news-banner.php");
                        break;
                    case "sua-news-banner":
                        include_once("template/news-banner/sua-news-banner.php");
                        break;
                    case "xoa-news-banner":
                        include_once("template/news-banner/xoa-news-banner.php");
                        break;
                    ///////////// Default /////////////////
                    default:
