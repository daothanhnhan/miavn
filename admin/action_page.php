...
class action_page extends library{
	...
	/*--------------- Danh mục sản phẩm -------------------*/
		...
		public function deleteProductCat(){
			...
			if ($productcat_id == 139 || $productcat_id == 140 || $productcat_id == 124 || $productcat_id == 141) {
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$product_size = isset($_POST['product_size']) ? $_POST['product_size'] : '0';
			...
			$product_laptop = isset($_POST['product_laptop']) ? $_POST['product_laptop'] : '0';

			$product_special = isset($_POST['product_special']) ? $_POST['product_special'] : 0;

			$product_color = isset($_POST['product_color']) ? $_POST['product_color'] : 0;

			$product_group_id = isset($_POST['product_group_id']) ? $_POST['product_group_id'] : 0;

			$product_video = isset($_POST['product_video']) ? $_POST['product_video'] : '';

			$product_gift_name = isset($_POST['product_gift_name']) ? $_POST['product_gift_name'] : '';

			//////////////
			$product_extra = isset($_POST['product_extra']) ? $_POST['product_extra'] : '';
			if ($product_extra != '') {
				$product_extra = implode(",", $product_extra);
			}
   ...
   //          }
	    	...
	    	if (isset($_FILES['fileUpload11']) && $_FILES['fileUpload11']['name'] != "") {

		    	$img = $_FILES['fileUpload11'];
	    		...
	    		$img_gift = isset($_POST['product_gift_image']) ? $_POST['product_gift_image'] : '';
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssiiissssissssiiisiii');
   ...
   //          }
	...
	/*------------------ Tin tức -------------------*/
		...
		public function addNews(){
			...
			$news_hot = isset($_POST['news_hot']) ? $_POST['news_hot'] : '0';
